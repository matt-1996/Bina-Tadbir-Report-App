...
<div class="min-h-screen rtl  bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
    <div class="grid grid-cols-1 px-5 my-24 md:my-2 lg:my-2 gap-6 mt-4 sm:grid-cols-2">
    ...
    <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
        <li>
            <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
                <img class="w-12 h-12 mb-3 ml-2  mr-3 rounded-full sm:mb-0" src="{{asset("img/logo.jpg")}}" alt="Jese Leos image"/>
                <div class="text-gray-600 dark:text-gray-400">
                    ...
                    <span class="inline-flex items-center text-xs font-normal text-gray-500 dark:text-gray-400">
                        <svg class="w-2.5 h-2.5 ml-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <li>
            <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
                <img class="w-12 h-12 mb-3 ml-2 mr-3 rounded-full sm:mb-0" src="{{asset("img/logo.jpg")}}" alt="Bonnie Green image"/>
                <div>
...
<div class="p-5 border border-gray-100 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
    ...
    <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
        <li>
            <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
                <img class="w-12 h-12 mb-3 ml-2 mr-3 rounded-full sm:mb-0" src="{{asset("img/logo.jpg")}}" alt="Laura Romeros image"/>
                <div class="text-gray-600 dark:text-gray-400">
        ...
        <li>
            <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
                <img class="w-12 h-12 mb-3 ml-2 mr-3 rounded-full sm:mb-0" src="{{asset("img/logo.jpg")}}" alt="Mike Willi image"/>
                <div>
    ...
    {{-- <div class="p-5 m-5 bg-gray-400">Hi</div> --}}
</body>
</html>
