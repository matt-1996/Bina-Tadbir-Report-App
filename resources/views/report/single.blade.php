...
<body dir="rtl">
    ...
    <div class="min-h-screen rtl bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
        ...
        <section class="max-w-4xl lg:w-3/4 p-6 mx-auto bg-gray-800 rounded-md shadow-md dark:bg-gray-800 mt-20">
            ...
            @if(Session::has('ClientUpdateSuccess'))
            <p class="p-4 text-lg text-white">{{Session::get('ClientUpdateSuccess')}}</p>
            @endif
               ...
               <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        ...
                        <label class="text-gray-500 my-2 dark:text-gray-200" for="username">تاریخ پیامک اول <span id="message1Span" class="text-gray-100 text-sm px-2 bg-blue-600 rounded-lg m-2 cursor-pointer">امروز</span></label>
                        ...
                        @else
                        <label class="text-gray-500 dark:text-gray-200" for="username">تاریخ پیامک اول <span id="message1Span" class="text-gray-100 text-sm px-2 bg-blue-600 rounded-lg m-2 cursor-pointer">امروز</span></label>
                    ...
                    <label class="text-gray-500 dark:text-gray-200" for="username">تاریخ پیامک دوم <span id="message2Span" class="text-gray-100 text-sm px-2 bg-blue-600 rounded-lg m-2 cursor-pointer">امروز</span></label>
                    ...
                    <label class="text-gray-500 dark:text-gray-200" for="username">تاریخ پیامک سوم<span id="message3Span" class="text-gray-100 text-sm px-2 bg-blue-600 rounded-lg m-2 cursor-pointer">امروز</span></label>
                    ...
                    <label class="text-gray-500 dark:text-gray-200" for="username">تاریخ تماس اول <span id="call1Span" class="text-gray-100 text-sm px-2 bg-blue-600 rounded-lg m-2 cursor-pointer">امروز</span></label>
                    ...
                    <div>
                        ...
                        <label class="text-gray-500 dark:text-gray-200" for="username">تاریخ تماس دوم <span id="call2Span" class="text-gray-100 text-sm px-2 bg-blue-600 rounded-lg m-2 cursor-pointer">امروز</span></label>
                    ...
                    @if ($report->call['call3'])
                        <label class="text-gray-500 dark:text-gray-200" for="username">تاریخ تماس سوم <span id="call3Span" class="text-gray-100 text-sm px-2 bg-blue-600 rounded-lg m-2 cursor-pointer">امروز</span></label>
                    ...
                    <div>
                        <label class="text-gray-500 dark:text-gray-200" for="username">تاریخ ارسال گزارش به شرکت <span id="sendReportClientDateSpan" class="text-gray-100 text-sm px-2 bg-blue-600 rounded-lg m-2 cursor-pointer">امروز</span> </label>
