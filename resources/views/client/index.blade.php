...
<div class="relative  overflow-x-auto shadow-md sm:rounded-lg">
    <div class="pb-4 p-4 bg-white dark:bg-gray-900">
        ...
        <div class="relative mt-1">
            ...
            <input type="text" id="table-search" class="block p-2 pr-8 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="جستجو">
        </div>
    </div>
