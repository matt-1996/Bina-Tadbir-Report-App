...
<div class="relative  overflow-x-auto shadow-md sm:rounded-lg">
    <div class="pb-4 p-4 mt-10 bg-gray-900 dark:bg-gray-900">
    ...
    <table id="table" class="w-full text-sm text-right text-gray-400 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-gray-800 border-b border-gray-700 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-600 dark:hover:bg-gray-600">
